        ...
        <>
            ...
            >
                <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] flex flex-col border border-gray-200">
                    ...
                    {/* 하단 입력바 + 정보 - iPhone Style */}
                    <div className="flex-shrink-0 bg-white/95 backdrop-blur-lg border-t border-gray-200/30">
                        {/* 첨부 썸네일 */}
                        {attachments.length > 0 && (
                            <div className="px-3 pt-2 pb-1 flex gap-2 overflow-x-auto">
                                {attachments.map((att, i) => (
                                    <div key={i} className="relative w-12 h-12 rounded-xl overflow-hidden border border-gray-200/50">
                                        <img src={att.url} alt={'att-' + i} className="w-full h-full object-cover" />
                                        <button
                                            className="absolute -top-1 -right-1 bg-black/70 text-white rounded-full w-4 h-4 text-[10px] flex items-center justify-center"
                        ...
                        <div className="px-2 py-1.5">
                            <div className="flex items-end gap-1.5">
                                <button
                                    ...
                                    className="p-1.5 rounded-full hover:bg-gray-100/80 active:scale-95 transition-all"
                                    aria-label="첨부"
                                >
                                    <Paperclip className="w-5 h-5 text-gray-500" />
                                </button>
                                <div className="flex-1 flex items-end bg-gray-100/60 rounded-full px-3.5 py-1 transition-all">
                                    <textarea
                                        ref={textareaRef}
                                        value={draft}
                                        onChange={(e) => {
                                        ...
                                        placeholder="메시지"
                                        rows={1}
                                        className="flex-1 resize-none bg-transparent outline-none text-[15px] leading-5 max-h-[100px] placeholder:text-gray-400 py-1.5"
                                        style={{
                                            height: '24px',
                                            scrollbarWidth: 'none',
                                ...
                                <button
                                    ...
                                    className={`h-8 w-8 rounded-full flex items-center justify-center transition-all transform ${canSend && !sending
                                        ? 'bg-blue-500 hover:bg-blue-600 text-white scale-100'
                                        : 'bg-blue-500/30 text-white/60 scale-90'
                                        }`}
                                    aria-label="전송"
                                >
                                    <svg
